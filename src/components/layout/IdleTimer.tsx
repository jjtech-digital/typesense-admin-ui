...
export function IdleTimer() {
  ...
  // logout("idle") clears only the cookie — localStorage saved config is preserved
  // so the login form will be pre-filled on next visit
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4">
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <p className="text-xs text-gray-400">
            Your connection details are remembered — you can reconnect instantly.
          </p>
